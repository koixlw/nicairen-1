          ...
          <div v-if="currentStep === 1" class="step-panel">
            ...
            <div class="shape-grid">
              <div
                ...
                :key="shape.id"
                class="shape-card"
                :class="{ selected: craft.shape === shape.id }"
        ...
        <transition name="fade-slide">
          <div v-if="currentStep === 2" class="step-panel">
            ...
            <div class="color-palette">
              <div
                v-for="color in pigments"
                :key="color.id"
                class="pigment-pot"
                :class="{ selected: craft.colors.includes(color.name) }"
                @click="toggleColor(color.name)"
                :title="color.desc"
              >
                <div
                  class="pigment-circle"
            ...
            <div class="pattern-list">
              <div
                ...
                :key="pat.id"
                class="pattern-tag"
                :class="{ selected: craft.pattern === pat.name }"
                @click="selectPattern(pat.name)"
              >
          ...
          <div v-if="currentStep === 3" class="step-panel">
            ...
            <div class="prompt-container">
              <textarea
                ...
                class="calligraphy-input"
                placeholder="在此描述神态、动作或场景细节..."
                rows="4"
              ></textarea>
              <button
                class="voice-btn"
