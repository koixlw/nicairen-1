        ...
        <transition name="fade-slide">
          <div v-if="currentStep === 1" class="step-panel">
            ...
            <div class="upload-area">
              <div
                class="dropzone"
                :class="{ active: dragActive, filled: contentImageUrl }"
              ...
              >
                ...
                <div v-if="!contentImageUrl" class="dropzone-content">
                  ...
                  <p>
                    拖拽图片到此，或<span
                      @click="$refs.contentInputRef?.click()"
                      class="click-upload"
                      >点击上传</span
                    >
                  </p>
                ...
                <div v-else class="preview-container">
                  ...
                  <button class="remove-btn" @click="contentImageUrl=''">
                    ✕
                  </button>
                </div>
              </div>
            ...
            <div class="style-section">
              ...
              <div class="style-grid">
                <div
                  ...
                  :key="style.id"
                  class="style-card"
                  :class="{ selected: presetStyle === style.id }"
            ...
            <div class="style-section mt-6">
              ...
              <div class="dropzone small" :class="{ filled: styleImageUrl }">
                ...
                <div
                  ...
                  @click="$refs.styleInputRef?.click()"
                >
                ...
                <div v-else class="preview-container">
                  ...
                  <button class="remove-btn" @click="styleImageUrl=''">
                    ✕
                  </button>
                </div>
              </div>
      ...
      <div v-if="fusionImageUrl && !generating" class="certificate-view">
        <div class="certificate-paper">
          ...
          <div class="cert-header">
            ...
            <span class="cert-no"
              >No.{{ Date.now().toString().slice(-8) }}</span
            >
          </div>

          <div
            class="artwork-frame"
            :class="[presetStyle, { 'with-border': withBorder }]"
          >
            <img
              :src="fusionImageUrl"
              alt="融合结果"
          ...
          <div class="cert-body">
            ...
            <div class="info-row">
              ...
              <span class="value"
                >AI 风格融合 / {{ getSelectedStyleName() }} / 强度{{ blend }}%</span
              >
            </div>
            <div class="info-row">
...
<script setup lang="ts">
  ...
  function selectStyle(id) {
    presetStyle.value = id;
  }
  function getSelectedStyleName() {
    return (
      presetStyles.find((s) => s.id === presetStyle.value)?.name || "未知风格"
    );
  }
...
<style scoped>
  ...
  .artwork-frame.with-border::before {
    ...
    background: repeating-linear-gradient(
      45deg,
      rgba(185, 44, 35, 0.25) 0 8px,
      rgba(240, 208, 160, 0.25) 8px 16px
    );
    -webkit-mask:
