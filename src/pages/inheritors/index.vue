      ...
      <div class="container">
        ...
        <div v-else-if="paginatedInheritors.length > 0" class="inheritors-grid">
          <div
            ...
            v-for="(inheritor, index) in paginatedInheritors"
            :key="inheritor.id"
          ...
          >
            ...
            <div class="card-header">
              <div class="img-frame">
                <div
                  class="img-blur-bg"
                  :style="{ backgroundImage: `url(${inheritor.imageUrl || defaultImage})` }"
                ></div>
                <img
                  :src="inheritor.imageUrl || defaultImage"
                  :alt="inheritor.name"
                  class="inheritor-img"
                >
  ...
  const loadFallbackData = () => {
    ...
    if (selectedLevel.value !== "all") {
      filteredData = filteredData.filter(
        (inheritor) => inheritor.level === selectedLevel.value
      );
    }
    ...
    if (selectedRegion.value !== "all") {
      filteredData = filteredData.filter(
        (inheritor) => inheritor.region === selectedRegion.value
      );
    }
