        ...
        <div class="title-wrapper">
          ...
          <div class="title-content" v-if="newsDetail">
            ...
            <p class="page-subtitle">
              {{ getCategoryText(newsDetail.category) }}
            </p>
          </div>
          ...
          <div class="content-main">
              ...
              <div class="news-meta">
                <span class="meta-item category">
                  ...
                  <span class="meta-text"
                    >{{ getCategoryText(newsDetail.category) }}</span
                  >
                </span>
                ...
                <span class="meta-item date">
                  ...
                  <span class="meta-text"
                    >{{ formatDate(newsDetail.date) }}</span
                  >
                </span>
                <span class="meta-divider">|</span>
                <span class="meta-item author">
                  ...
                  <span class="meta-text"
                    >{{ newsDetail.author || '非遗文化宣传中心' }}</span
                  >
                </span>
                <span class="meta-divider">|</span>
            ...
            <div class="share-section" v-if="newsDetail">
              ...
              <div class="share-buttons">
                <button
                  class="share-btn"
                  @click="showWeixinCode = !showWeixinCode"
                >
...
<script setup lang="ts">
  ...
  import { getHotNews, getNewsDetailById } from "@/api/news";
  ...
  const relatedNews = computed(() => {
    ...
    if (related.length < 3) {
      const additionalNews = hotNewsList.value
        .filter(
          (item) =>
            item.id !== newsId.value && !related.some((r) => r.id === item.id)
        )
