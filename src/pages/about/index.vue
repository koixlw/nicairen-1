  ...
  <div class="about-page">
    ...
    <header class="hero-section">
      <video
        ...
        loop
        playsinline
        poster="@/assets/images/xuanchuan.png"
      >
      ...
      <div class="container hero-content">
        <div class="hero-text-wrapper">
          <h1 class="main-title">
            <span class="title-line" :class="{ 's-visible': loaded }"
              >守护非遗</span
            >
            <span class="title-line accent" :class="{ 's-visible': loaded }"
              >重塑新生</span
            >
          </h1>
        ...
        <div class="mission-grid">
          <div class="mission-text" v-scroll-reveal>
            ...
            <h2 class="section-heading">
              一群追逐光的
              <br>
              <span class="highlight-text">守艺人</span>
            </h2>
            <div class="text-content">
              <p>
                ...
                缘起于对<strong
                  >泥彩人</strong
                >古老艺术的惊鸿一瞥，我们决定停下脚步，去倾听泥土的声音。
              </p>
              <p>
                面对非遗技艺面临的传承困境，我们一直在思考：
                如何让千年的泥彩人走出博物馆，走进年轻人的生活？ 我们试图用<strong
                  >AI赋能</strong
                >、<strong>数字档案</strong>和<strong
                  >创新文创</strong
                >，为这门千年手艺寻找通往未来的船票。
              </p>
            </div>
            ...
            <div class="stats-row" ref="statsRef">
              ...
              >
                <span class="stat-num">
                  {{ stat.isSymbol ? stat.value : Math.round(stat.current) }}
                  {{ stat.suffix }}
                </span>
      ...
      <div class="container">
        <div class="section-header text-center" v-scroll-reveal>
          ...
          <h2 class="section-heading-lg">
            科技与匠心的<span class="text-primary">交融</span>
          </h2>
          <p class="section-desc">
            仅仅记录是不够的，我们致力于建立一个完整的数字化传承生态。
          </p>
        </div>
...
<script setup lang="ts">
  ...
  // 视差效果状态
  const parallaxStyle = ref<{ transform: string; transition?: string }>({
