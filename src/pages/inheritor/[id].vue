      ...
      <div class="container">
              ...
              <div class="hero-left">
                <div class="image-container">
                  <div class="image-frame">
                    <img
                      :src="detail.basicInfo.imageUrl || '/assets/images/image.png'"
                      :alt="detail.basicInfo.name"
                      class="inheritor-image"
                      loading="lazy"
                      decoding="async"
                    >
                ...
                <div class="info-grid">
                  <div class="info-item">
                    ...
                    <div class="info-content">
                      ...
                      <span class="info-value"
                        >{{ detail.basicInfo.regionDisplayName }}</span
                      >
                    </div>
                  </div>
                  <div class="info-item">
                  ...
                  <div class="info-item" v-if="detail.basicInfo.craftType">
                    ...
                    <div class="info-content">
                      ...
                      <span class="info-value"
                        >{{ detail.basicInfo.craftType }}</span
                      >
                    </div>
                  </div>
                </div>
        ...
        <section class="section-card" v-if="detail.fullBiography">
          ...
          <div class="section-content">
            <div class="biography-text">{{ detail.fullBiography }}</div>
          </div>
        </section>
        ...
        <section class="section-card" v-if="detail.personalStory">
          ...
          <div class="section-content">
            <div class="story-content">
              ...
              <div class="story-text">{{ detail.personalStory }}</div>
            </div>
          </div>
        </section>
        ...
        <!-- 艺术理念 -->
        <section
          class="section-card philosophy-section"
          v-if="detail.philosophy"
        >
          <div class="section-header">
            <div class="section-title-wrapper">
              <div class="title-decoration"></div>
        ...
        <section
          class="section-card"
          v-if="detail.educationBackground || detail.masterInfo"
        >
          <div class="section-header">
            <div class="section-title-wrapper">
              <div class="title-decoration"></div>
        ...
        <section class="section-card" v-if="detail.careerHistory">
          ...
          <div class="section-content">
            <div class="career-text">{{ detail.careerHistory }}</div>
          </div>
        </section>
        ...
        <section class="section-card" v-if="detail.majorWorks">
          ...
          <div class="section-content">
            <div class="works-content">
              ...
              <div class="works-text">{{ detail.majorWorks }}</div>
            </div>
          </div>
        </section>
        ...
        <section
          class="section-card"
          v-if="detail.teachingExperience || detail.apprenticesInfo"
        >
          <div class="section-header">
            <div class="section-title-wrapper">
              <div class="title-decoration"></div>
        ...
        <section class="section-card" v-if="detail.culturalImpact">
          ...
          <div class="section-content">
            <div class="impact-text">{{ detail.culturalImpact }}</div>
          </div>
        </section>
            ...
            <div class="workshop-content">
              ...
              <div class="workshop-info">
                ...
                <p class="workshop-hint" v-if="detail.officialWebsite">
                  官方网站：<a :href="detail.officialWebsite" target="_blank"
                    >{{ detail.officialWebsite }}</a
                  >
                </p>
              </div>
            </div>
