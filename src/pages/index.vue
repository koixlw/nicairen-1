    ...
    >
      <div class="banner-slider">
        <div class="banner-track" :style="bannerTrackStyle">
          ...
          <div class="banner-item">
            <img
              src="../assets/images/chuanchengren.jpg"
              alt="泥彩人体验活动"
              class="banner-img"
            >
            <div class="banner-content">
      ...
      <div class="container">
        ...
        <div class="about-content" v-scroll-reveal>
          <div class="about-text">
            ...
            <router-link to="/introduction" class="about-btn">
              了解更多
            </router-link>
          </div>
      ...
      <div class="container">
        ...
        <div class="ai-card" v-scroll-reveal>
          ...
          <div class="ai-card-image">
            <img
              src="../assets/images/wenshengtu.png"
              alt="文生图预览"
              class="ai-card-img"
            >
          </div>
        ...
        <div class="ai-card" style="margin-top: 24px;" v-scroll-reveal>
          ...
          <div class="ai-card-image">
            <img
              src="../assets/images/nirenhuadan.jpg"
              alt="图生图预览"
              class="ai-card-img"
            >
          </div>
        ...
        <div class="reserve-content" v-scroll-reveal>
          <div class="reserve-text">
            ...
            <ul class="reserve-features">
              <li
                class="feature-item animate-feature"
          ...
          <div class="reserve-image">
            <img
              ...
              alt="泥彩人体验活动"
              class="reserve-img parallax-img"
            >
          </div>
        </div>
      </div>
    ...
    <section class="shop-section">
      <div class="container">
        ...
        <div class="shop-grid" v-scroll-reveal>
          <div
            class="shop-item shop-card-animate"
