            ...
            <form class="reserve-form" @submit.prevent="submitReservation">
              ...
              <div class="form-group">
                ...
                >
                  ...
                  >
                    {{ activityType.name }} - {{ activityType.basePrice }}
                    元/人，{{ activityType.duration }}分钟
                  </option>
                </select>
              ...
              <div class="form-group">
                ...
                <div class="date-notice" v-if="formData.reservationDate">
                  ...
                  <span
                    v-if="isHoliday(formData.reservationDate)"
                    class="holiday"
                    >节假日</span
                  >
                </div>
              ...
              <div class="form-group">
                <label class="form-label">
                  预约时间段 <span class="required">*</span>
                </label>
                <div class="time-slots">
                  <button
                    ...
                    @click="selectTimeSlot(slot.time, slot.id)"
                  >
                    {{ slot.time }}
                    <span class="time-slot-status">{{ slot.status }}</span>
                  </button>
                </div>
                <div class="error-message" v-if="errors.timeSlot">
                  {{ errors.timeSlot }}
                </div>
              </div>
              ...
              <div
                class="form-group"
                v-if="formData.reservationType === 'group'"
              >
                <label for="groupName" class="form-label">
                  团体名称 <span class="required">*</span>
                </label>
                <input
                  type="text"
                  id="groupName"
                  ...
                  required
                >
                <div class="error-message" v-if="errors.groupName">
                  {{ errors.groupName }}
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="char-count">
                  {{ formData.specialRequirements.length }}/200
                </div>
              </div>
              ...
              <div class="form-group agreement-group">
                ...
                <div class="error-message" v-if="errors.agreeTerms">
                  {{ errors.agreeTerms }}
                </div>
              </div>
            ...
            <div class="info-card">
              ...
              <div class="info-content">
                <ul class="notice-list">
                  <li>
                    请提前至少3天进行个人预约，团体预约（10人以上）需提前7天。
                  </li>
                  <li>预约成功后，我们将通过短信或电话确认您的预约信息。</li>
                  <li>
                    如需取消预约，请提前24小时通知我们，否则将收取30%的费用。
                  </li>
            ...
            <div class="info-card contact-card">
              ...
              <div class="info-content">
                ...
                <div class="contact-options">
                  ...
                  <a
                    href="mailto:reserve@nicairen.com"
    ...
    >
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          <div class="terms-content">
            ...
            <ol>
              ...
              <li>预约成功后，我们将通过短信或电话确认您的预约信息。</li>
              <li>
                每张预约单最多可预约50人，超过50人请分开预约或联系我们进行团体预约。
              </li>
            ...
            <ol>
              ...
              <li>
                12岁以下儿童需由成人陪同参加体验活动，成人需全程负责儿童的安全。
              </li>
            ...
            <ol>
              <li>
                体验费用包含：泥彩人制作所需的所有材料、工具使用、专业指导费用。
              </li>
        ...
        <div class="modal-footer">
          <button class="modal-btn" @click="showTermsModal = false">
            我知道了
          </button>
        </div>
      </div>
      ...
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          <div class="terms-content">
            ...
            <h4>三、信息保护</h4>
            <p>
              我们采取严格的安全措施保护您的个人信息，防止信息泄露、丢失或被篡改。
            </p>

            <h4>四、信息共享</h4>
            <p>
              未经您的明确许可，我们不会向任何第三方共享您的个人信息，法律另有规定的除外。
            </p>
        ...
        <div class="modal-footer">
          <button class="modal-btn" @click="showPrivacyModal = false">
            我知道了
          </button>
        </div>
      </div>
...
<script setup lang="ts">
  ...
  const availableTimeSlots = computed(() => {
    ...
    if (
      ...
      isHoliday(formData.value.reservationDate)
    ) {
      slots.push({
        id: 6,
        time: "19:30-21:00",
  ...
  const onReservationTypeChange = () => {
    if (
      formData.value.reservationType === "group" &&
  ...
  const submitReservation = async () => {
    ...
    try {
      ...
      const formDataToSubmit = {
        ...formData.value,
        reservationDate:
          formData.value.reservationDate instanceof Date
      ...
      alert(
        `预约提交成功！预约编号：${response.reservationNumber}，我们会在24小时内与您联系确认详情。`
      );
