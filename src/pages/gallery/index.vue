  ...
  <div class="gallery">
    ...
    <section class="gallery-section">
      <div class="container">
            ...
            <div class="card-info">
              ...
              <div class="work-meta">
                <span class="meta-category"
                  >{{ getCategoryText(work.category) }}</span
                >
        ...
        <div
          class="pagination"
          v-if="totalPages > 1 && filteredWorks.length > 0"
        >
          <button
            class="page-btn"
            @click="currentPage = 1"
  ...
  const allWorks = ref<Work[]>([
    {
      ...
      title: "大阿福",
      description:
        "传统无锡泥人代表作，象征吉祥如意，福气满满。造型圆润饱满，色彩鲜艳喜庆。",
    ...
    },
    {
      ...
      title: "龙凤呈祥",
      description:
        "以中国传统吉祥图案为题材，龙与凤相互呼应，寓意吉祥喜庆，适合新婚贺礼。",
    ...
    },
    {
      ...
      title: "十二生肖-鼠",
      description:
        "以中国传统十二生肖为题材，生动刻画了鼠的灵动形象，细节丰富，栩栩如生。",
    ...
    },
    {
      ...
      title: "京剧脸谱",
      description:
        "以京剧脸谱为创作灵感，色彩鲜明，线条流畅，展现了中国传统戏曲文化的魅力。",
    ...
    },
    {
      ...
      title: "童趣",
      description:
        "现代创意泥彩人作品，描绘了儿童玩耍的场景，造型简约，充满生活气息。",
    ...
    },
    {
      ...
      title: "西游记人物群像",
      description:
        "根据中国古典名著《西游记》创作的人物群像，唐僧师徒四人形象鲜明，神态各异。",
    ...
    },
    {
      ...
      title: "连年有余",
      description:
        "传统吉祥题材泥彩人，描绘了莲花和鲤鱼的形象，寓意年年有余，生活富足。",
    ...
    },
    {
      ...
      title: "城市之光",
      description:
        "现代风格泥彩人作品，以城市建筑为题材，展现了现代都市的繁荣景象。",
    ...
    },
    {
      ...
      title: "十二生肖-龙",
      description:
        "十二生肖系列中的龙作品，造型威严大气，细节精致，展现了龙的神圣与力量。",
    ...
    },
    {
      ...
      title: "红楼梦人物",
      description:
        "根据古典名著《红楼梦》创作的人物形象，林黛玉的形象刻画细腻，神态优雅。",
    ...
    },
    {
      ...
      title: "丰收",
      description:
        "民俗风情题材作品，描绘了农民丰收的喜悦场景，充满生活气息和乡土情怀。",
    ...
    },
    {
      ...
      title: "嫦娥奔月",
      description:
        "根据中国传统神话故事创作，嫦娥飘逸的姿态和月球的细节处理精美。",
    ...
    },
    {
      ...
      title: "数字时代",
      description:
        "现代创意作品，结合了传统泥彩人技艺和现代数字元素，寓意传统与现代的融合。",
    ...
    },
    {
      ...
      title: "福禄寿三星",
      description:
        "传统吉祥题材，福星、禄星、寿星三位神仙形象，寓意幸福、富贵、长寿。",
    ...
    },
    {
      ...
      title: "三国演义人物",
      description:
        "根据古典名著《三国演义》创作的人物形象，关羽的形象威风凛凛，细节精致。",
